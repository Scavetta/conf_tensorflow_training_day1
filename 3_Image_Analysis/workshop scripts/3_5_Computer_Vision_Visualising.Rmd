...
img_path <- "/../../usr/share/class/cats_and_dogs/test/cats/cat.1700.jpg"
img <- _______(img_path, target_size = c(150, 150))


img_tensor <- _______(img)
img_tensor <- _______(img_tensor, c(1, 150, 150, 3))
