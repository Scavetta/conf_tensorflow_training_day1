...
After freezing large chunks of our convnet, we can choose to unfree specific components.

| Function           | Description                                |
|:-------------------|:-------------------------------------------|
| `image_load()`     | Import and resize an image.                |
| `image_to_array()` | Import and resize an image.                |
| `array_reshape()`  | Reshape an arry for use with tensorflow.   |
...
Here are some additional visualization functions from the _Deep Lerning with R_ book that you can execute to visualize you filters. We won't go into detail in the workshop. All outputs are save in the working directory.
