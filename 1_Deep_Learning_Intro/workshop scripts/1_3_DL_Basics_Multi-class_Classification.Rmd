...
In this case study, we'll perform a single-label, multi-class classification to predict one of 4 possible outcomes from 13 predictor variables. 4 is an arbitrary value I've choosen for example purposes, of course in reality there can be many more classes.
