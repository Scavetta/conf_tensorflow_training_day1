...
quiz(caption = "Loss Functions",
  question("What is the purpose of a loss function?",
           answer("Informs us how to to update our parameters given the result of the loss function", correct = TRUE),
           answer("It's the function whose result we are trying to minimize"),
           answer("Informs us how to to update our parameters after each pass-through."),
           allow_retry = T,
           correct = "Great! There are a few different optimizer functions to choose from."
  ),
  question("Which are examples of loss functions that we saw in the workshop?",
           answer("Sigmoid"),
           answer("None (i.e. scalar)", correct = TRUE),
           answer("Categorical Crossentropy", correct = TRUE),
           answer("Binary Crossentropy", correct = TRUE),
