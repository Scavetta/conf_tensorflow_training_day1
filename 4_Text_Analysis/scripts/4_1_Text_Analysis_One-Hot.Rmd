---
title: "Binary Classification with Text: The Reuter Dataset"
...
c(c(train_data, train_labels), c(test_data, test_labels)) %<-% dataset_Reuter(num_words = 10000)
```
...
The `_labels` objects contain the review labels. Each review can only have one *label* (i.e. "sigle-label"), from a total of 46 possible *classes* (i.e. "multi-class").
