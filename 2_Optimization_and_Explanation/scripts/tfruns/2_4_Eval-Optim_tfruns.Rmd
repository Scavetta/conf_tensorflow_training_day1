...
Now that we've seen how adjusting hyperparameters helps us to avoid over-fitting, let's see how the `tfruns` package helps us to perfom grid search.
...
| Function         | Use                                                                                                                                                                        |
|:-----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `training_run()` | Run a `keras` model from start to finish contained in a separate script (`*.R`) file. Save the results to the `runs` directory and automaticall view them as an HTML page. |
...
| `flags()`        | Provide separate inputs used in the sourse script for `training_run()`.                                                                                                    |
| `flag_numeric()` | Specify the actual names and defualt values of inputs.                                                                                                                     |
| `ls_runs()`      | Summarise the results of all runs in the `runs` directory as a data frame.                                                                                                 |
