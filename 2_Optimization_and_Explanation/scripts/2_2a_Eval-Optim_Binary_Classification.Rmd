...
subtitle: "Classification -- Binary, with simple validation"
...
We already saw how to obtain and transform the data, so I'm just going to call those functions here.
...
Let's set apart 101 samples in our training data to use as a validation set:
